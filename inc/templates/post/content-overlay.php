...
echo '<div class="saxon-overlay-post saxon-post'.esc_attr($post_class).'"'.saxon_add_aos(false).'>';
...
<?php echo '<div class="post-excerpt">'.wp_kses_post( saxon_get_the_excerpt(235, $post->ID) ).'</div>'; ?>
