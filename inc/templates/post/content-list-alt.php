...
echo '<div class="saxon-list-post saxon-list-post-alt saxon-post'.esc_attr($post_class).'"'.saxon_add_aos(false).'>';
...
echo '<div class="saxon-post-details-inside">';
...
echo wp_kses_post( saxon_get_the_excerpt(200, $post->ID) );
