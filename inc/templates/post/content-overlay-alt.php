<?php
/**
 * Post template: Overlay alt (categories at top, post details at bottom)
 */
...
echo '<div class="saxon-overlay-alt-post saxon-post'.esc_attr($post_class).'"'.saxon_add_aos(false).'>';
