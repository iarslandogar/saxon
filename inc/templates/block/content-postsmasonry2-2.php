 ...
 * Block: Posts Masonry 2 - Second, Third posts
 */
...
echo '<div class="saxon-postsmasonry2-post saxon-postsmasonry2_2-post saxon-post'.esc_attr($post_class).'"'.saxon_add_aos(false).'>';
