 ...
 * Block: Posts Masonry 1 - First post
 */
...
echo '<div class="saxon-postsmasonry1-post saxon-postsmasonry1_1-post saxon-post'.esc_attr($post_class).'"'.saxon_add_aos(false).'>';
...
<?php echo '<div class="post-excerpt">'.wp_kses_post( saxon_get_the_excerpt(350, $post->ID) ).'</div>'; ?>
