 ...
 */
	...
	add_action( 'wp_enqueue_scripts', 'saxon_enqueue_dynamic_js', '999' );

	if(!function_exists('saxon_enqueue_dynamic_js')):
	function saxon_enqueue_dynamic_js( ) {
	...
	if(!function_exists('saxon_get_js')):
	function saxon_get_js () {
		// ===
		ob_start();
    ?>
    (function($){
