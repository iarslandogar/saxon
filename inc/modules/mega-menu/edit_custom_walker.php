	        ...
	        <dl class="menu-item-bar">
	            <dt class="menu-item-handle">
	                ...
	                <span class="item-controls">
	                    ...
	                    <a class="item-edit" id="edit-<?php echo esc_attr($item_id); ?>" title="<?php esc_attr_e('Edit Menu Item', 'saxon'); ?>" href="<?php
	        ...
	        <div class="menu-item-settings" id="menu-item-settings-<?php echo esc_attr($item_id); ?>">
				...
				<p class="field-background-url description description-wide">
	                <label for="edit-menu-item-background_url-<?php echo esc_attr($item_id); ?>">
	                	...
	                	<input class="button upload-menu-item-bg" name="upload-menu-item-bg" type="text" data-uploader_button_text="<?php esc_attr_e('Select image', 'saxon'); ?>" data-uploader_title="Select submenu background image" value="<?php esc_attr_e('Select image', 'saxon'); ?>" />
	                	<input class="button remove-menu-item-bg" name="remove-menu-item-bg" type="text" style="width: 80px;" value="<?php esc_attr_e('Remove', 'saxon'); ?>" />
	                </label>
	            </p>
	            ...
	            <div class="menu-item-actions description-wide submitbox">
	                <?php if( 'custom' != $item->type && $original_title !== false ) : ?>
	                    <p class="link-to-original">
	                        <?php printf( esc_html__('Original: %s', 'saxon'), '<a href="' . esc_url( $item->url ) . '">' . esc_html( $original_title ) . '</a>' ); ?>
	                    </p>
	                <?php endif; ?>
	                ...
	                ); ?>"><?php esc_html_e('Remove', 'saxon'); ?></a> <span class="meta-sep"> | </span> <a class="item-cancel submitcancel" id="cancel-<?php echo esc_attr($item_id); ?>" href="<?php echo esc_url( add_query_arg( array('edit-menu-item' => $item_id, 'cancel' => time()), esc_url(remove_query_arg( $removed_args, admin_url( 'nav-menus.php' ) )) ) );
	                    ?>#menu-item-settings-<?php echo esc_attr($item_id); ?>"><?php esc_html_e('Cancel', 'saxon'); ?></a>
	            </div>
